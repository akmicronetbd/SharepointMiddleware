...
SHAREPOINT_UPLOAD_URL = "https://kymsoffice.sharepoint.com/sites/TestProjectOnline/DPGO RFP Project/_api/web/GetFolderByServerRelativeUrl('Contract Library/Test')/Files/Add"
